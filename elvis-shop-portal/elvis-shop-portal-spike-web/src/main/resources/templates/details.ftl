...
<head>
  ...
  <link rel="stylesheet" href="http://pq1vc0zfm.bkt.clouddn.com/index.css">
  <link rel="stylesheet" href="http://pq1vc0zfm.bkt.clouddn.com/layui.css">
</head>
<body>
...
<style type="text/css">
		...
		<script type="text/javascript">
			window.onload = function countTime() {
				...
				if (leftTime > 1) {
					//活动剩余时间
					document.getElementById("_end").innerHTML = "活动剩余<span class='_end'> " + d + "天</span> <span class='_end'> " + h +
						"时</span> <span class='_end'> " + m + "分</span> <span class='_end'> " + s + "秒</span> ";
				} else {
					//倒计时结束
...
<div class="layui-container house-detail">
  <p class="title"><a href="index.html">首页</a> &gt; <a href="list.html">家居用品</a> &gt; <span>产品详情</span></p>
  	 <div style="background-color: #fb4856;"> <span class="layui-badge"  >抢购</span><span>距离活动结束还有:</span> 	<span id="_end"></span></div>

  <div class="layui-row price">
    <div class="layui-col-sm6">
      <div class="intro-img"><img src="../res/static/img/goods_img1.jpg"></div><ul class="thumb">
    ...
    <div class="layui-col-sm6 shopChoose">
      ...
      <div class="title"  ><p><span class="layui-badge">新品</span>轻奢吊灯现代极简创意灯具</p>好评率  <span>90%</span></div>
      <p><span>￥<big><b>199</b></big></span>原价￥<big><del>399</del></big></p>
