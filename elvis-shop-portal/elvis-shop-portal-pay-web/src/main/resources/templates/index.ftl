...
<body>
	<div class="head">
		<div class="head-center">
			...
			<div class="head-center-user">用户名：712338173@qq.com</div>
		</div>
		...
		<div class="scent">
			...
			<div class="scent-pay">
				...
				<div class="scent-pay-type">
					...
					<a href="/payHtml?channelId=${p.channelId}&payToken=${RequestParameters.payToken}"><button
		...
		<div class="footer">Copyright © 2016 - 2020 ShanShanKindergarten. All Rights
			Reserved 珊珊幼儿园 版权所有</div>
	</div>
</body>
...
<script type="text/javascript">
	...
	if (isMobile) {
		...
		console.log("珊珊幼儿园PC手机版本充值...")
	} else {
		console.log("珊珊幼儿园PC电脑版本充值...")
	}
