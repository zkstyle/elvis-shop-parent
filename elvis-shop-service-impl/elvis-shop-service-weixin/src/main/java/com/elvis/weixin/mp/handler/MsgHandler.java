package com.elvis.weixin.mp.handler;
...
import com.elvis.core.utils.RegexUtils;
import com.elvis.weixin.mp.builder.TextBuilder;
...
public class MsgHandler extends AbstractHandler {
    // 用户发送手机验证码提示
    @Value("${elvis.weixin.registration.code.message}")
    private String registrationCodeMessage;
    // 默认用户发送验证码提示
    @Value("${elvis.weixin.default.registration.code.message}")
    ...
    public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage, Map<String, Object> context, WxMpService weixinService,
        ...
        if (RegexUtils.checkMobile(fromContent)) {
            ...
            if (!resultUserInfo.getCode().equals(Constants.HTTP_RES_CODE_EXIST_MOBILE_203)){
