package com.elvis.pay.mq.producer;
 ...
 * @BelongsPackage: com.elvis.pay.mq.producer
 * @Author: elvis
...
public class IntegralProducer implements RabbitTemplate.ConfirmCallback {
	...
	private static final String INTEGRAL_ROUTINGKEY = "integralRoutingKey";
	...
	public void send(JSONObject jsonObject) {
		...
		rabbitTemplate.convertAndSend(INTEGRAL_EXCHANGE_NAME, INTEGRAL_ROUTINGKEY, message, correlationData);
